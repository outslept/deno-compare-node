...
Updated May 11, 2026 • Node.js v26.1.0 • deno 2.7.14+2b3e623 (canary, release, x86_64-unknown-linux-gnu)
...
[Object: null prototype] {
    ...
    default: {
        ...
        cp: [Circular: *27],
        cpSync: [Circular: *28],
        createReadStream: [Circular: *29],
        createWriteStream: [Circular: *30],
        Dir: [Circular: *4],
        Dirent: [Circular: *5],
        ...
        openSync: <ref *65> ƒ openSync(length: 1) {},
        opendir: <ref *66> ƒ opendir(length: 3) {},
        opendirSync: <ref *67> ƒ opendirSync(length: 2) {},
        read: <ref *68> ƒ read(length: 6) {},
        readSync: <ref *69> ƒ readSync(length: 5) {},
        promises: <ref *70> {
            ...
            watch: <ref *102> ƒ watchPromise(length: 2) {}
        },
        ...
        realpathSync: <ref *113> ƒ realpathSync(length: 2) {
            native: ƒ realpathSync_native(length: 2) {}
        },
        readv: <ref *115> ƒ readv(length: 4) {},
        readvSync: <ref *116> ƒ readvSync(length: 2) {},
        rename: <ref *117> ƒ rename(length: 3) {},
        renameSync: <ref *118> ƒ renameSync(length: 2) {},
        rmdir: <ref *119> ƒ rmdir(length: 3) {},
        rmdirSync: <ref *120> ƒ rmdirSync(length: 2) {},
        rm: <ref *121> ƒ rm(length: 3) {},
        rmSync: <ref *122> ƒ rmSync(length: 2) {},
        stat: <ref *123> ƒ stat(length: 1) {},
        Stats: [Circular: *7],
        statSync: <ref *124> ƒ statSync(length: 1) {},
        statfs: <ref *125> ƒ statfs(length: 3) {},
        statfsSync: <ref *126> ƒ statfsSync(length: 2) {},
        symlink: <ref *127> ƒ symlink(length: 4) {},
        symlinkSync: <ref *128> ƒ symlinkSync(length: 3) {},
        truncate: <ref *129> ƒ truncate(length: 1) {},
        truncateSync: <ref *130> ƒ truncateSync(length: 1) {},
        unlink: <ref *131> ƒ unlink(length: 2) {},
        unlinkSync: <ref *132> ƒ unlinkSync(length: 1) {},
        unwatchFile: <ref *133> ƒ unwatchFile(length: 2) {},
        utimes: <ref *134> ƒ utimes(length: 4) {},
        utimesSync: <ref *135> ƒ utimesSync(length: 3) {},
        watch: <ref *136> ƒ watch(length: 3) {},
        watchFile: <ref *137> ƒ watchFile(length: 3) {},
        write: <ref *138> ƒ write(length: 6) {},
        writeFile: <ref *139> ƒ writeFile(length: 4) {},
        writev: <ref *140> ƒ writev(length: 4) {},
        writevSync: <ref *141> ƒ writevSync(length: 3) {},
        writeFileSync: <ref *142> ƒ writeFileSync(length: 3) {},
        WriteStream: [Circular: *10],
    ...
    openSync: [Circular: *65],
    opendir: [Circular: *66],
    opendirSync: [Circular: *67],
    promises: [Circular: *70],
    read: [Circular: *68],
    readFile: [Circular: *105],
    readFilePromise: [Circular: *106],
    readFileSync: [Circular: *107],
    readSync: [Circular: *69],
    ...
    readvSync: [Circular: *116],
    realpath: [Circular: *111],
    realpathSync: [Circular: *113],
    rename: [Circular: *117],
    renameSync: [Circular: *118],
    rm: [Circular: *121],
    rmSync: [Circular: *122],
    rmdir: [Circular: *119],
    rmdirSync: [Circular: *120],
    stat: [Circular: *123],
    statSync: [Circular: *124],
    statfs: [Circular: *125],
    statfsSync: [Circular: *126],
    symlink: [Circular: *127],
    symlinkSync: [Circular: *128],
    truncate: [Circular: *129],
    truncateSync: [Circular: *130],
    unlink: [Circular: *131],
    unlinkSync: [Circular: *132],
    unwatchFile: [Circular: *133],
    utimes: [Circular: *134],
    utimesSync: [Circular: *135],
    watch: [Circular: *136],
    watchFile: [Circular: *137],
    watchPromise: [Circular: *102],
    write: [Circular: *138],
    writeFile: [Circular: *139],
    writeFileSync: [Circular: *142],
    writeSync: [Circular: *143],
    writev: [Circular: *140],
    writevSync: [Circular: *141]
}
```
...
[Object: null prototype] {
    ...
    default: {
        ...
        truncate: <ref *14> ƒ truncate(length: 1) {},
        ...
        appendFile: [Circular: *3],
        readFile: <ref *34> ƒ readFile(length: 3) {},
...
[Object: null prototype] {
    ...
    default: {
        ...
        Agent: [Circular: *2],
        [get/set] globalAgent: <ref *13> Agent {
            _events: [Object: null prototype] {
                free: ƒ (length: 2) {},
                newListener: ƒ maybeEnableKeylog(length: 1) {}
            },
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        _pathCache: <ref *4> [Object: null prototype] {
            /tmp/fs-fixture-1778467000127-2459-1/module.mjs: "/tmp/fs-fixture-1778467000127-2459-1/module.mjs"
        },
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        register: <ref *26> ƒ register(length: 3) {}
    },
    _cache: [Circular: *10],
...
Error importing module: No such built-in module: node:sea
    at file:///tmp/fs-fixture-1778467000127-2459-1/sea.mjs:3:32
...
Error importing module: No such built-in module: node:test/reporters
    at file:///tmp/fs-fixture-1778467000127-2459-1/test_reporters.mjs:3:32
...
[Object: null prototype] {
    ...
    argv: <ref *23> [
        ...
        "/tmp/fs-fixture-1778467000127-2459-1/process.mjs"
    ],
    argv0: "node",
    ...
    default: process {
        ...
        env: <ref *116>  {
            GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_1c5b38e8-69c9-4c89-ae60-5858f884013a",
            DOTNET_NOLOGO: "1",
            USER: "runner",
            ...
            GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_1c5b38e8-69c9-4c89-ae60-5858f884013a",
            PIPX_HOME: "/opt/pipx",
            ...
            GITHUB_HEAD_REF: "",
            SYSTEMD_EXEC_PID: "2102",
            ACTIONS_ORCHESTRATION_ID: "aa180d6f-fa3f-48ed-a4b1-916101e0092d.comparison.__default",
            ...
            GITHUB_RUN_ID: "25647354684",
            GITHUB_REF_TYPE: "branch",
            BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            GITHUB_WORKFLOW_SHA: "614ca25168b13db36dbef7672d78399d4a30149d",
            GITHUB_BASE_REF: "",
            ImageOS: "ubuntu24",
            ...
            RUNNER_TRACKING_ID: "github_3acf2f35-9016-4f86-84db-f075589db743",
            INVOCATION_ID: "ba7ca495288f4a41a0dcc825e8b56ff2",
            ...
            GITHUB_SHA: "614ca25168b13db36dbef7672d78399d4a30149d",
            GITHUB_RUN_ATTEMPT: "1",
            GITHUB_REF: "refs/heads/main",
            GITHUB_ACTOR: "outslept",
            ANDROID_SDK_ROOT: "/usr/local/lib/android/sdk",
            GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_1c5b38e8-69c9-4c89-ae60-5858f884013a",
            ...
            GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_1c5b38e8-69c9-4c89-ae60-5858f884013a",
            ...
            GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_1c5b38e8-69c9-4c89-ae60-5858f884013a",
...
[Object: null prototype] {
    ...
    arch: "x64",
    argv: <ref *6> [
        "/opt/hostedtoolcache/deno/0.0.0-2b3e6239b47a6f516cac4c739ff246db9c55ff13/x64/deno",
        "/tmp/fs-fixture-1778467000127-2459-1/process.mjs"
    ],
    argv0: "deno",
    ...
    execPath: "/opt/hostedtoolcache/deno/0.0.0-2b3e6239b47a6f516cac4c739ff246db9c55ff13/x64/deno",
    exit: [Circular: *20],
...
(node:3063) [DEP0025] DeprecationWarning: sys is deprecated. Use `node:util` instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
...
[Object: null prototype] {
    ...
    default: {
        ...
        getSystemErrorMessage: <ref *115> ƒ getSystemErrorMessage(length: 1) {},
        getSystemErrorName: <ref *116> ƒ getSystemErrorName(length: 1) {},
        isDeepStrictEqual: <ref *117> ƒ isDeepStrictEqual(length: 3) {}
    },
    deprecate: [Circular: *112],
    format: [Circular: *12],
    formatWithOptions: [Circular: *13],
    getCallSites: [Circular: *113],
    getSystemErrorMessage: [Circular: *115],
    getSystemErrorName: [Circular: *116],
    inherits: [Circular: *109],
    inspect: [Circular: *14],
    isArray: [Circular: *108],
    isDeepStrictEqual: [Circular: *117],
    log: [Circular: *111],
...
Error importing module: No such built-in module: node:trace_events
    at file:///tmp/fs-fixture-1778467000127-2459-1/trace_events.mjs:3:32
...
[Object: null prototype] {
    ...
    compileFunction: <ref *5> ƒ compileFunction(length: 2) {},
    constants: <ref *6> [Object: null prototype] {
    ...
    default: {
        ...
        runInNewContext: <ref *11> ƒ runInNewContext(length: 3) {},
        runInThisContext: <ref *12> ƒ runInThisContext(length: 2) {},
        isContext: <ref *13> ƒ isContext(length: 1) {},
        compileFunction: [Circular: *5],
        measureMemory: <ref *14> ƒ measureMemory(length: 1) {}
    },
...
(node:3233) ExperimentalWarning: WASI is an experimental feature and might change at any time
