...
Updated Mar 16, 2026 • Node.js v25.8.1 • deno 2.7.5+895fa89 (canary, release, x86_64-unknown-linux-gnu)
...
[Object: null prototype] {
    ...
    default: {
        ...
        transcode: <ref *24> ƒ transcode(length: 3) {}
    },
    isAscii: [Circular: *21],
    isUtf8: [Circular: *22],
    kMaxLength: 9007199254740991,
...
[Object: null prototype] {
    ...
    default: {
        ...
        publicDecrypt: <ref *54> ƒ publicDecrypt(length: 0) {},
...
```js
[Object: null prototype] {
    BigIntStats: ƒ BigIntStats(length: 14) {},
    CFISBIS: ƒ CFISBIS(length: 2) {},
    Dir: <ref *4> class Dir {},
    Dirent: <ref *5> class Dirent {},
    ReadStream: <ref *6> ƒ ReadStream(length: 2) {},
    Stats: <ref *7> ƒ Stats(length: 14) {},
    WriteStream: <ref *8> ƒ WriteStream(length: 2) {},
    _toUnixTimestamp: <ref *9> ƒ toUnixTimestamp(length: 1) {},
    access: <ref *10> ƒ access(length: 3) {},
    accessSync: <ref *11> ƒ accessSync(length: 2) {},
    appendFile: <ref *12> ƒ appendFile(length: 4) {},
    appendFileSync: <ref *13> ƒ appendFileSync(length: 3) {},
    chmod: <ref *14> ƒ chmod(length: 3) {},
    chmodSync: <ref *15> ƒ chmodSync(length: 2) {},
    chown: <ref *16> ƒ chown(length: 4) {},
    chownSync: <ref *17> ƒ chownSync(length: 3) {},
    close: <ref *18> ƒ close(length: 1) {},
    closeSync: <ref *19> ƒ closeSync(length: 1) {},
    ...
    convertFileInfoToBigIntStats: ƒ convertFileInfoToBigIntStats(length: 1) {},
    convertFileInfoToStats: ƒ convertFileInfoToStats(length: 1) {},
    copyFile: <ref *23> ƒ copyFile(length: 4) {},
    copyFileSync: <ref *24> ƒ copyFileSync(length: 3) {},
    cp: <ref *25> ƒ cp(length: 4) {},
    cpSync: <ref *26> ƒ cpSync(length: 3) {},
    createReadStream: <ref *27> ƒ createReadStream(length: 2) {},
    createWriteStream: <ref *28> ƒ createWriteStream(length: 2) {},
    default: {
        access: [Circular: *10],
        ...
        constants: [Circular: *20],
        copyFile: [Circular: *23],
        copyFileSync: [Circular: *24],
        cp: [Circular: *25],
        cpSync: [Circular: *26],
        createReadStream: [Circular: *27],
        createWriteStream: [Circular: *28],
        Dir: [Circular: *4],
        Dirent: [Circular: *5],
        exists: <ref *30> ƒ exists(length: 2) {},
        existsSync: <ref *31> ƒ existsSync(length: 1) {},
        fchmod: <ref *32> ƒ fchmod(length: 3) {},
        fchmodSync: <ref *33> ƒ fchmodSync(length: 2) {},
        fchown: <ref *34> ƒ fchown(length: 4) {},
        fchownSync: <ref *35> ƒ fchownSync(length: 3) {},
        fdatasync: <ref *36> ƒ fdatasync(length: 2) {},
        fdatasyncSync: <ref *37> ƒ fdatasyncSync(length: 1) {},
        fstat: <ref *38> ƒ fstat(length: 3) {},
        fstatSync: <ref *39> ƒ fstatSync(length: 2) {},
        fsync: <ref *40> ƒ fsync(length: 2) {},
        fsyncSync: <ref *41> ƒ fsyncSync(length: 1) {},
        ftruncate: <ref *42> ƒ ftruncate(length: 3) {},
        ftruncateSync: <ref *43> ƒ ftruncateSync(length: 2) {},
        futimes: <ref *44> ƒ futimes(length: 4) {},
        futimesSync: <ref *45> ƒ futimesSync(length: 3) {},
        glob: <ref *46> ƒ glob(length: 2) {},
        globSync: <ref *47> ƒ globSync(length: 1) {},
        lchmod: undefined,
        lchmodSync: undefined,
        lchown: <ref *48> ƒ lchown(length: 4) {},
        lchownSync: <ref *49> ƒ lchownSync(length: 3) {},
        link: <ref *50> ƒ link(length: 3) {},
        linkSync: <ref *51> ƒ linkSync(length: 2) {},
        lstat: <ref *52> ƒ lstat(length: 3) {},
        lstatSync: <ref *53> ƒ lstatSync(length: 2) {},
        lutimes: <ref *54> ƒ lutimes(length: 4) {},
        lutimesSync: <ref *55> ƒ lutimesSync(length: 3) {},
        mkdir: <ref *56> ƒ mkdir(length: 3) {},
        mkdirSync: <ref *57> ƒ mkdirSync(length: 2) {},
        mkdtemp: <ref *58> ƒ mkdtemp(length: 3) {},
        mkdtempSync: <ref *59> ƒ mkdtempSync(length: 2) {},
        open: <ref *60> ƒ open(length: 4) {},
        openAsBlob: <ref *61> ƒ openAsBlob(length: 1) {},
        openSync: <ref *62> ƒ openSync(length: 1) {},
        opendir: <ref *63> ƒ opendir(length: 3) {},
        opendirSync: <ref *64> ƒ opendirSync(length: 2) {},
        read: <ref *65> ƒ read(length: 6) {},
        readSync: <ref *66> ƒ readSync(length: 5) {},
        promises: <ref *67> {
            ...
            watch: <ref *98> ƒ watchPromise(length: 2) {}
        },
        readdir: <ref *99> ƒ readdir(length: 3) {},
        readdirSync: <ref *100> ƒ readdirSync(length: 2) {},
        readFile: <ref *101> ƒ readFile(length: 3) {},
        readFilePromise: <ref *102> ƒ readFilePromise(length: 2) {},
        readFileSync: <ref *103> ƒ readFileSync(length: 2) {},
        readlink: <ref *104> ƒ readlink(length: 3) {},
        readlinkPromise: <ref *105> ƒ readlink(length: 3) {},
        readlinkSync: <ref *106> ƒ readlinkSync(length: 2) {},
        ReadStream: [Circular: *6],
        realpath: <ref *107> ƒ realpath(length: 3) {
            native: [Circular: *107]
        },
        realpathSync: <ref *108> ƒ realpathSync(length: 2) {
            native: [Circular: *108]
        },
        readv: <ref *109> ƒ readv(length: 4) {},
        readvSync: <ref *110> ƒ readvSync(length: 2) {},
        rename: <ref *111> ƒ rename(length: 3) {},
        renameSync: <ref *112> ƒ renameSync(length: 2) {},
        rmdir: <ref *113> ƒ rmdir(length: 3) {},
        rmdirSync: <ref *114> ƒ rmdirSync(length: 2) {},
        rm: <ref *115> ƒ rm(length: 3) {},
        rmSync: <ref *116> ƒ rmSync(length: 2) {},
        stat: <ref *117> ƒ stat(length: 1) {},
        Stats: [Circular: *7],
        statSync: <ref *118> ƒ statSync(length: 1) {},
        statfs: <ref *119> ƒ statfs(length: 3) {},
        statfsSync: <ref *120> ƒ statfsSync(length: 2) {},
        ...
        writeFile: <ref *133> ƒ writeFile(length: 4) {},
        writev: <ref *134> ƒ writev(length: 4) {},
        writevSync: <ref *135> ƒ writevSync(length: 3) {},
        writeFileSync: <ref *136> ƒ writeFileSync(length: 3) {},
        WriteStream: [Circular: *8],
        writeSync: <ref *137> ƒ writeSync(length: 5) {},
        _toUnixTimestamp: [Circular: *9]
    },
    exists: [Circular: *30],
    existsSync: [Circular: *31],
    fchmod: [Circular: *32],
    fchmodSync: [Circular: *33],
    fchown: [Circular: *34],
    fchownSync: [Circular: *35],
    fdatasync: [Circular: *36],
    fdatasyncSync: [Circular: *37],
    fstat: [Circular: *38],
    fstatSync: [Circular: *39],
    fsync: [Circular: *40],
    fsyncSync: [Circular: *41],
    ftruncate: [Circular: *42],
    ftruncateSync: [Circular: *43],
    futimes: [Circular: *44],
    futimesSync: [Circular: *45],
    glob: [Circular: *46],
    globSync: [Circular: *47],
    lchmod: undefined,
    lchmodSync: undefined,
    lchown: [Circular: *48],
    lchownSync: [Circular: *49],
    link: [Circular: *50],
    linkSync: [Circular: *51],
    lstat: [Circular: *52],
    lstatSync: [Circular: *53],
    lutimes: [Circular: *54],
    lutimesSync: [Circular: *55],
    mkdir: [Circular: *56],
    mkdirSync: [Circular: *57],
    mkdtemp: [Circular: *58],
    mkdtempSync: [Circular: *59],
    open: [Circular: *60],
    openAsBlob: [Circular: *61],
    openSync: [Circular: *62],
    opendir: [Circular: *63],
    opendirSync: [Circular: *64],
    promises: [Circular: *67],
    read: [Circular: *65],
    readFile: [Circular: *101],
    readFilePromise: [Circular: *102],
    readFileSync: [Circular: *103],
    readSync: [Circular: *66],
    readdir: [Circular: *99],
    readdirSync: [Circular: *100],
    readlink: [Circular: *104],
    readlinkPromise: [Circular: *105],
    readlinkSync: [Circular: *106],
    readv: [Circular: *109],
    readvPromise: ƒ readvPromise(length: 3) {},
    readvSync: [Circular: *110],
    realpath: [Circular: *107],
    realpathSync: [Circular: *108],
    rename: [Circular: *111],
    renameSync: [Circular: *112],
    rm: [Circular: *115],
    rmSync: [Circular: *116],
    rmdir: [Circular: *113],
    rmdirSync: [Circular: *114],
    stat: [Circular: *117],
    statSync: [Circular: *118],
    statfs: [Circular: *119],
    statfsSync: [Circular: *120],
    ...
    watchPromise: [Circular: *98],
    write: [Circular: *132],
    writeFile: [Circular: *133],
    writeFileSync: [Circular: *136],
    writeSync: [Circular: *137],
    writev: [Circular: *134],
    writevSync: [Circular: *135]
}
```
...
[Object: null prototype] {
    ...
    default: {
        ...
        link: <ref *24> ƒ link(length: 3) {},
        unlink: <ref *25> ƒ unlink(length: 2) {},
        chmod: [Circular: *4],
        lchmod: <ref *26> ƒ (length: 0) {},
        lchown: <ref *27> ƒ lchown(length: 4) {},
        chown: [Circular: *5],
        utimes: <ref *28> ƒ utimes(length: 4) {},
        lutimes: <ref *29> ƒ lutimes(length: 4) {},
        realpath: <ref *30> ƒ realpath(length: 3) {},
        mkdtemp: <ref *31> ƒ mkdtemp(length: 3) {},
        writeFile: <ref *32> ƒ writeFile(length: 4) {},
        appendFile: [Circular: *3],
        readFile: <ref *33> ƒ readFile(length: 3) {},
        watch: <ref *34> ƒ watchPromise(length: 2) {}
    },
    glob: [Circular: *10],
    lchmod: [Circular: *26],
    lchown: [Circular: *27],
...
[Object: null prototype] {
    ...
    constants: <ref *6> [Object: null prototype] {
        ...
        HTTP_STATUS_EXPECTATION_FAILED: 417,
        HTTP_STATUS_MISDIRECTED_REQUEST: 421,
        NGHTTP2_ERR_FRAME_SIZE_ERROR: 4294966774,
        NGHTTP2_SESSION_SERVER: 0,
        NGHTTP2_SESSION_CLIENT: 1,
        NGHTTP2_STREAM_STATE_IDLE: 1,
        NGHTTP2_STREAM_STATE_OPEN: 2,
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        _pathCache: <ref *4> [Object: null prototype] {
            /tmp/fs-fixture-1773626050274-2477-1/module.mjs: "/tmp/fs-fixture-1773626050274-2477-1/module.mjs"
        },
        ...
        globalPaths: <ref *9> [
            ...
            "/opt/hostedtoolcache/node/25.8.1/x64/lib/node"
        ],
...
Error importing module: No such built-in module: node:sea
    at file:///tmp/fs-fixture-1773626050274-2477-1/sea.mjs:3:32
...
[Object: null prototype] {
    ...
    backup: <ref *4> async ƒ backup(length: 2) {},
    constants: <ref *5> {
        SQLITE_CHANGESET_OMIT: 0,
        SQLITE_CHANGESET_REPLACE: 1,
        SQLITE_CHANGESET_ABORT: 2,
...
Error importing module: No such built-in module: node:test/reporters
    at file:///tmp/fs-fixture-1773626050274-2477-1/test_reporters.mjs:3:32
...
[Object: null prototype] {
    ...
    PerformanceObserver: <ref *3> class PerformanceObserver extends WebPerformanceObserver {},
...
[Object: null prototype] {
    ...
    arch: "x64",
    argv: <ref *22> [
        "/opt/hostedtoolcache/node/25.8.1/x64/bin/node",
        "/tmp/fs-fixture-1773626050274-2477-1/process.mjs"
    ],
    argv0: "node",
    ...
    constrainedMemory: <ref *40> ƒ constrainedMemory(length: 0) {},
    cpuUsage: <ref *41> ƒ cpuUsage(length: 1) {},
    cwd: <ref *42> ƒ wrappedCwd(length: 0) {},
    debugPort: 9229,
    default: process {
        version: "v25.8.1",
        versions: <ref *44> {
        ...
        release: <ref *45> {
            name: "node",
            sourceUrl: "https://nodejs.org/download/release/v25.8.1/node-v25.8.1.tar.gz",
            headersUrl: "https://nodejs.org/download/release/v25.8.1/node-v25.8.1-headers.tar.gz"
        },
        _rawDebug: [Circular: *14],
        moduleLoadList: <ref *46> [
        ...
        config: [Circular: *26],
        dlopen: <ref *47> ƒ dlopen(length: 0) {},
        uptime: <ref *48> ƒ uptime(length: 0) {},
        _getActiveRequests: [Circular: *10],
        _getActiveHandles: [Circular: *9],
        getActiveResourcesInfo: <ref *49> ƒ getActiveResourcesInfo(length: 0) {},
        reallyExit: <ref *50> ƒ reallyExit(length: 0) {},
        _kill: [Circular: *11],
        loadEnvFile: <ref *51> ƒ loadEnvFile(length: 0) {},
        cpuUsage: [Circular: *41],
        threadCpuUsage: <ref *52> ƒ threadCpuUsage(length: 1) {},
        resourceUsage: <ref *53> ƒ resourceUsage(length: 0) {},
        memoryUsage: <ref *54> ƒ memoryUsage(length: 0) {
            rss: ƒ rss(length: 0) {}
        },
        constrainedMemory: [Circular: *40],
        availableMemory: [Circular: *23],
        kill: <ref *56> ƒ kill(length: 2) {},
        exit: <ref *57> ƒ exit(length: 1) {},
        execve: <ref *58> ƒ execve(length: 1) {},
        ref: <ref *59> ƒ ref(length: 1) {},
        unref: <ref *60> ƒ unref(length: 1) {},
        ...
        getuid: <ref *68> ƒ getuid(length: 0) {},
        geteuid: <ref *69> ƒ geteuid(length: 0) {},
        getgid: <ref *70> ƒ getgid(length: 0) {},
        getegid: <ref *71> ƒ getegid(length: 0) {},
        getgroups: <ref *72> ƒ getgroups(length: 0) {},
        ...
        setUncaughtExceptionCaptureCallback: <ref *74> ƒ setUncaughtExceptionCaptureCallback(length: 1) {},
        hasUncaughtExceptionCaptureCallback: <ref *75> ƒ hasUncaughtExceptionCaptureCallback(length: 0) {},
        emitWarning: <ref *76> ƒ emitWarning(length: 4) {},
        nextTick: <ref *77> ƒ nextTick(length: 1) {},
        _tickCallback: [Circular: *17],
        [get/set] sourceMapsEnabled: false,
        setSourceMapsEnabled: <ref *78> ƒ setSourceMapsEnabled(length: 1) {},
        getBuiltinModule: <ref *79> ƒ getBuiltinModule(length: 1) {},
        _debugProcess: [Circular: *3],
        _debugEnd: [Circular: *2],
        _startProfilerIdleNotifier: [Circular: *15],
        _stopProfilerIdleNotifier: [Circular: *16],
        [get/set] stdout: <ref *80> Socket {
            connecting: false,
            _hadError: false,
            _parent: null,
            _host: null,
            ...
            _events: {
                ...
                drain: undefined,
                data: undefined,
                end: <ref *82> ƒ onReadableStreamEnd(length: 0) {},
                readable: undefined
            },
            ...
            fd: 1,
            _isStdio: true,
            destroySoon: <ref *88> ƒ (length: 2) {},
            _destroy: <ref *89> ƒ dummyDestroy(length: 2) {},
            Symbol(async_id_symbol): 2,
            Symbol(kHandle): Pipe {
                Symbol(owner_symbol): [Circular: *80]
            },
        ...
        [get/set] stdin: <ref *91> Socket {
            ...
            Symbol(kHandle): Pipe {
                reading: false,
                Symbol(owner_symbol): [Circular: *91]
            },
            Symbol(lastWriteQueueSize): 0,
            Symbol(timeout): null,
            Symbol(kBuffer): null,
        ...
        [get/set] stderr: <ref *100> Socket {
            ...
            fd: 2,
            _isStdio: true,
            destroySoon: [Circular: *88],
            _destroy: [Circular: *89],
            Symbol(async_id_symbol): 4,
            Symbol(kHandle): Pipe {
                Symbol(owner_symbol): [Circular: *100]
            },
            Symbol(lastWriteQueueSize): 0,
            Symbol(timeout): null,
            Symbol(kBuffer): null,
        ...
        abort: [Circular: *18],
        umask: <ref *108> ƒ wrappedUmask(length: 1) {},
        chdir: [Circular: *25],
        cwd: [Circular: *42],
        initgroups: <ref *109> ƒ initgroups(length: 2) {},
        setgroups: <ref *110> ƒ setgroups(length: 1) {},
        setegid: <ref *111> ƒ (length: 1) {},
        seteuid: <ref *112> ƒ (length: 1) {},
        setgid: <ref *113> ƒ (length: 1) {},
        setuid: <ref *114> ƒ (length: 1) {},
        env: <ref *115>  {
            GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_57bea1e0-bfcb-4eba-a084-4c422a55ea69",
            DOTNET_NOLOGO: "1",
            USER: "runner",
            npm_config_user_agent: "pnpm/10.10.0 npm/? node/v25.8.1 linux x64",
            CI: "true",
            USE_BAZEL_FALLBACK_VERSION: "silent:",
            RUNNER_ENVIRONMENT: "github-hosted",
            GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_57bea1e0-bfcb-4eba-a084-4c422a55ea69",
            PIPX_HOME: "/opt/pipx",
            npm_node_execpath: "/opt/hostedtoolcache/node/25.8.1/x64/bin/node",
            ...
            GITHUB_HEAD_REF: "",
            SYSTEMD_EXEC_PID: "2142",
            ACTIONS_ORCHESTRATION_ID: "f56c8951-94c3-4224-b325-eecdba3d5c29.comparison.__default",
            ...
            GITHUB_RUN_ID: "23124662551",
            GITHUB_REF_TYPE: "branch",
            BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            GITHUB_WORKFLOW_SHA: "5c0f851a7e368ef7e8c87eb46c9ccf898d6de2d4",
            GITHUB_BASE_REF: "",
            ImageOS: "ubuntu24",
            ...
            RUNNER_TRACKING_ID: "github_4b106e21-0931-4ecf-9369-be2f4c4497d7",
            INVOCATION_ID: "4097f589c0a94c1983d2767f92e1c480",
            RUNNER_TOOL_CACHE: "/opt/hostedtoolcache",
            npm_package_name: "deno-compare-node",
            NODE: "/opt/hostedtoolcache/node/25.8.1/x64/bin/node",
            ...
            RUNNER_NAME: "GitHub Actions 1000003708",
            ...
            GITHUB_SHA: "5c0f851a7e368ef7e8c87eb46c9ccf898d6de2d4",
            GITHUB_RUN_ATTEMPT: "1",
            GITHUB_REF: "refs/heads/main",
            GITHUB_ACTOR: "outslept",
            ANDROID_SDK_ROOT: "/usr/local/lib/android/sdk",
            GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_57bea1e0-bfcb-4eba-a084-4c422a55ea69",
            ...
            GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_57bea1e0-bfcb-4eba-a084-4c422a55ea69",
            ...
            GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_57bea1e0-bfcb-4eba-a084-4c422a55ea69",
        ...
        pid: 2936,
        ppid: 2477,
        execPath: "/opt/hostedtoolcache/node/25.8.1/x64/bin/node",
        debugPort: 9229,
        argv0: "node",
        _preload_modules: [Circular: *13],
        [get/set] report: <ref *117> {
    ...
    dlopen: [Circular: *47],
    domain: null,
    emitWarning: [Circular: *76],
    env: [Circular: *115],
    execArgv: [Circular: *116],
    execPath: "/opt/hostedtoolcache/node/25.8.1/x64/bin/node",
    execve: [Circular: *58],
    exit: [Circular: *57],
    exitCode: undefined,
    features: [Circular: *73],
    finalization: [Circular: *61],
    getActiveResourcesInfo: [Circular: *49],
    getBuiltinModule: [Circular: *79],
    getegid: [Circular: *71],
    geteuid: [Circular: *69],
    getgid: [Circular: *70],
    getgroups: [Circular: *72],
    getuid: [Circular: *68],
    hasUncaughtExceptionCaptureCallback: [Circular: *75],
    hrtime: [Circular: *65],
    initgroups: [Circular: *109],
    kill: [Circular: *56],
    loadEnvFile: [Circular: *51],
    memoryUsage: [Circular: *54],
    moduleLoadList: [Circular: *46],
    nextTick: [Circular: *77],
    openStdin: [Circular: *67],
    pid: 2936,
    platform: "linux",
    ppid: 2477,
    reallyExit: [Circular: *50],
    ref: [Circular: *59],
    release: [Circular: *45],
    report: [Circular: *117],
    resourceUsage: [Circular: *53],
    setSourceMapsEnabled: [Circular: *78],
    setUncaughtExceptionCaptureCallback: [Circular: *74],
    setegid: [Circular: *111],
    seteuid: [Circular: *112],
    setgid: [Circular: *113],
    setgroups: [Circular: *110],
    setuid: [Circular: *114],
    sourceMapsEnabled: false,
    stderr: [Circular: *100],
    stdin: [Circular: *91],
    stdout: [Circular: *80],
    threadCpuUsage: [Circular: *52],
    title: "node",
    umask: [Circular: *108],
    unref: [Circular: *60],
    uptime: [Circular: *48],
    version: "v25.8.1",
    versions: [Circular: *44]
}
```
...
[Object: null prototype] {
    ...
    default: EventEmitter {
        ...
        nextTick: <ref *24> ƒ nextTick(length: 1) {},
        dlopen: <ref *25> ƒ dlopen(length: 3) {},
        setSourceMapsEnabled: ƒ (length: 1) {},
        [get/set] sourceMapsEnabled: true,
        hrtime: <ref *27> ƒ hrtime(length: 1) {
            bigint: ƒ (length: 0) {}
        },
        _kill: ƒ _kill(length: 2) {},
        kill: <ref *30> ƒ kill(length: 1) {},
        memoryUsage: <ref *31> ƒ memoryUsage(length: 0) {
            rss: ƒ (length: 0) {}
        },
        availableMemory: [Circular: *7],
        constrainedMemory: [Circular: *9],
        stderr: <ref *33> Writable {
            _events: {
                close: undefined,
                error: undefined,
                prefinish: undefined,
        ...
        binding: ƒ (length: 1) {},
        umask: <ref *71> ƒ umask(length: 1) {},
        getgid: <ref *72> ƒ getgid(length: 0) {},
        getuid: <ref *73> ƒ getuid(length: 0) {},
        getegid: <ref *74> ƒ getegid(length: 0) {},
        geteuid: <ref *75> ƒ geteuid(length: 0) {},
        setegid: <ref *76> ƒ (length: 1) {},
        seteuid: <ref *77> ƒ (length: 1) {},
        setgid: <ref *78> ƒ (length: 1) {},
        setuid: <ref *79> ƒ (length: 1) {},
        getBuiltinModule: <ref *80> ƒ getBuiltinModule(length: 1) {},
        _eval: undefined,
        loadEnvFile: <ref *81> ƒ loadEnvFile(length: 0) {},
        uptime: ƒ (length: 0) {},
        features: {
            inspector: true,
            debug: false,
    ...
    env: [Circular: *17],
    execArgv: [Circular: *18],
    execPath: "/opt/hostedtoolcache/deno/0.0.0-895fa89a809c60a069535f91ddb93ef7325b4288/x64/deno",
    exit: [Circular: *19],
    ...
    hrtime: [Circular: *27],
    kill: [Circular: *30],
    loadEnvFile: [Circular: *81],
    memoryUsage: [Circular: *31],
    nextTick: [Circular: *24],
    pid: 2947,
    platform: "linux",
    ppid: 2477,
...
(node:2949) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
...
(node:3116) [DEP0025] DeprecationWarning: sys is deprecated. Use `node:util` instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
...
[Object: null prototype] {
    ...
    default: {
        ...
        debuglog: [Circular: *7],
        debug: [Circular: *7],
        isDeepStrictEqual: <ref *111> ƒ isDeepStrictEqual(length: 3) {},
...
[Object: null prototype] {
    ...
    default: {
        ...
        setUnrefTimeout: <ref *11> ƒ setUnrefTimeout(length: 2) {},
        clearImmediate: [Circular: *2],
        promises: <ref *12> {
            setTimeout: [Circular: *7],
    ...
    promises: [Circular: *12],
    setImmediate: [Circular: *9],
    setInterval: [Circular: *8],
    setTimeout: [Circular: *6],
    setUnrefTimeout: [Circular: *11]
}
```
...
Error importing module: No such built-in module: node:trace_events
    at file:///tmp/fs-fixture-1773626050274-2477-1/trace_events.mjs:3:32
...
[Object: null prototype] {
    ...
    default: {
        ...
        writeHeapSnapshot: <ref *15> ƒ writeHeapSnapshot(length: 2) {},
...
```js
[Object: null prototype] {
    BroadcastChannel: <ref *2> class BroadcastChannel extends WebBroadcastChannel {},
