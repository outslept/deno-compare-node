...
Updated May 18, 2026 • Node.js v26.1.0 • deno 2.7.14+6dca921 (canary, release, x86_64-unknown-linux-gnu)
...
[Object: null prototype] {
    ...
    default: {
        ...
        groupCollapsed: [Circular: *19],
        groupEnd: <ref *20> ƒ groupEnd(length: 0) {},
        clear: [Circular: *4],
        trace: <ref *21> ƒ trace(length: 0) {},
        profile: <ref *22> ƒ profile(length: 1) {},
        profileEnd: <ref *23> ƒ profileEnd(length: 1) {},
        timeStamp: <ref *24> ƒ timeStamp(length: 1) {},
        indentLevel: 0,
        Console: [Circular: *2],
    ...
    log: [Circular: *9],
    profile: [Circular: *22],
    profileEnd: [Circular: *23],
    table: [Circular: *15],
    time: [Circular: *16],
    timeEnd: [Circular: *18],
    timeLog: [Circular: *17],
    timeStamp: [Circular: *24],
    trace: [Circular: *21],
    warn: [Circular: *13]
}
```
...
[Object: null prototype] {
    EventEmitter: <ref *2> ƒ EventEmitter(length: 1) {
        ...
        [get/set] defaultMaxListeners: 10,
        init: ƒ (length: 1) {},
        [get/set] EventEmitterAsyncResource: <ref *10> class EventEmitterAsyncResource
...
[Object: null prototype] {
    ...
    default: {
        ...
        [get/set] promises: <ref *68> {
            ...
            realpath: ƒ realpath(length: 3) {
                native: <ref *95> ƒ realpath_native(length: 3) {}
            },
            ...
            watch: <ref *101> ƒ watchPromise(length: 2) {}
        },
        read: <ref *102> ƒ read(length: 6) {},
        readdir: <ref *103> ƒ readdir(length: 3) {},
        readdirSync: <ref *104> ƒ readdirSync(length: 2) {},
        readFile: <ref *105> ƒ readFile(length: 3) {},
        readFilePromise: <ref *106> ƒ readFilePromise(length: 2) {},
        readFileSync: <ref *107> ƒ readFileSync(length: 2) {},
        readlink: <ref *108> ƒ readlink(length: 3) {},
        readlinkPromise: <ref *109> ƒ readlink(length: 3) {},
        readlinkSync: <ref *110> ƒ readlinkSync(length: 2) {},
        [get/set] ReadStream: [Circular: *6],
        readSync: <ref *111> ƒ readSync(length: 5) {},
        readv: <ref *112> ƒ readv(length: 4) {},
        readvPromise: <ref *113> ƒ readvPromise(length: 3) {},
        readvSync: <ref *114> ƒ readvSync(length: 2) {},
        realpath: <ref *115> ƒ realpath(length: 3) {
            native: [Circular: *95]
        },
        ...
        watchPromise: [Circular: *101],
        write: <ref *139> ƒ write(length: 6) {},
        writeFile: <ref *140> ƒ writeFile(length: 4) {},
        writeFileSync: <ref *141> ƒ writeFileSync(length: 3) {},
        [get/set] WriteStream: [Circular: *10],
        writeSync: <ref *142> ƒ writeSync(length: 5) {},
        writev: <ref *143> ƒ writev(length: 4) {},
        writevSync: <ref *144> ƒ writevSync(length: 3) {}
    },
    exists: [Circular: *32],
    ...
    read: [Circular: *102],
    readFile: [Circular: *105],
    readFilePromise: [Circular: *106],
    readFileSync: [Circular: *107],
    readSync: [Circular: *111],
    readdir: [Circular: *103],
    readdirSync: [Circular: *104],
    readlink: [Circular: *108],
    readlinkPromise: [Circular: *109],
    readlinkSync: [Circular: *110],
    readv: [Circular: *112],
    readvPromise: [Circular: *113],
    readvSync: [Circular: *114],
    realpath: [Circular: *115],
    ...
    watchPromise: [Circular: *101],
    write: [Circular: *139],
    writeFile: [Circular: *140],
    writeFileSync: [Circular: *141],
    writeSync: [Circular: *142],
    writev: [Circular: *143],
    writevSync: [Circular: *144]
}
```
...
[Object: null prototype] {
    ...
    default: {
        ...
        mkdtemp: <ref *32> ƒ mkdtemp(length: 3) {},
        mkdtempDisposable: <ref *33> async ƒ mkdtempDisposablePromise(length: 2) {},
        writeFile: <ref *34> ƒ writeFilePromise(length: 3) {},
        appendFile: [Circular: *3],
...
[Object: null prototype] {
    ...
    default: {
        ...
        setMaxIdleHTTPParsers: <ref *23> ƒ setMaxIdleHTTPParsers(length: 1) {},
        STATUS_CODES: [Circular: *7],
        validateHeaderName: <ref *24> ƒ __node_internal_(length: 0) {
            withoutStackTrace: ƒ __node_internal_(length: 2) {}
        },
        validateHeaderValue: <ref *26> ƒ __node_internal_(length: 0) {
            withoutStackTrace: ƒ __node_internal_(length: 2) {}
        }
    },
    get: [Circular: *13],
    ...
    maxHeaderSize: 16384,
    request: [Circular: *22],
    setMaxIdleHTTPParsers: [Circular: *23],
    validateHeaderName: [Circular: *24],
    validateHeaderValue: [Circular: *26]
}
```
...
[Object: null prototype] {
    ...
    Http2ServerRequest: <ref *3> class Http2ServerRequest extends lazyStream().Readable {},
    Http2ServerResponse: <ref *4> class Http2ServerResponse extends lazyStream().default {},
    Http2Session: <ref *5> class Http2Session extends EventEmitter {},
    Http2Stream: <ref *6> class Http2Stream extends Duplex {},
...
[Object: null prototype] {
    ...
    Session: <ref *18> class Session extends EventEmitter {},
...
[Object: null prototype] {
    ...
    Session: <ref *18> class Session extends inspector.Session {},
    close: <ref *19> ƒ close(length: 0) {},
    console: <ref *20> {
        debug: ƒ debug(length: 0) {},
        error: ƒ error(length: 0) {},
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        _pathCache: <ref *4> [Object: null prototype] {
            /tmp/fs-fixture-1779072294617-2426-1/module.mjs: "/tmp/fs-fixture-1779072294617-2426-1/module.mjs"
        },
        ...
        globalPaths: <ref *9> [
            ...
            "/opt/hostedtoolcache/node/26.1.0/x64/lib/node"
        ],
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        enableCompileCache: <ref *4> ƒ enableCompileCache(length: 1) {},
        flushCompileCache: <ref *5> ƒ flushCompileCache(length: 0) {},
        getCompileCacheDir: <ref *6> ƒ getCompileCacheDir(length: 0) {},
        constants: <ref *7> {
            compileCacheStatus: {
                ENABLED: 0,
                ALREADY_ENABLED: 1,
        ...
        _extensions: <ref *9> [Object: null prototype] {
            ...
            .mjs: ƒ loadEsm(length: 2) {},
            .wasm: ƒ loadESMFromCJS(length: 3) {},
            .json: ƒ (length: 2) {},
            .node: ƒ (length: 2) {}
        },
        _cache: <ref *16> [Object: null prototype] {},
        _pathCache: <ref *17> [Object: null prototype] {},
        globalPaths: <ref *18> [],
        _findPath: <ref *19> ƒ (length: 4) {},
        _nodeModulePaths: <ref *20> ƒ (length: 1) {},
        _resolveLookupPaths: <ref *21> ƒ (length: 2) {},
        _load: <ref *22> ƒ (length: 3) {},
        _resolveFilename: <ref *23> ƒ (length: 4) {},
        _preloadModules: <ref *24> ƒ (length: 1) {},
        isBuiltin: <ref *25> ƒ isBuiltin(length: 1) {},
        createRequire: <ref *26> ƒ createRequire(length: 1) {},
        _initPaths: <ref *27> ƒ (length: 0) {},
        syncBuiltinESMExports: ƒ syncBuiltinESMExports(length: 0) {},
        runMain: ƒ (length: 0) {},
        Module: [Circular: *2],
        findSourceMap: <ref *30> ƒ findSourceMap(length: 1) {},
        SourceMap: <ref *31> class SourceMap {}
    },
    SourceMap: [Circular: *31],
    _cache: [Circular: *16],
    _extensions: [Circular: *9],
    _findPath: [Circular: *19],
    _initPaths: [Circular: *27],
    _load: [Circular: *22],
    _nodeModulePaths: [Circular: *20],
    _pathCache: [Circular: *17],
    _preloadModules: [Circular: *24],
    _resolveFilename: [Circular: *23],
    ...
    default: [Circular: *2],
    enableCompileCache: [Circular: *4],
    findSourceMap: [Circular: *30],
    flushCompileCache: [Circular: *5],
    getBuiltinModule: ƒ getBuiltinModule(length: 1) {},
    getCompileCacheDir: [Circular: *6],
    globalPaths: [Circular: *18],
    isBuiltin: [Circular: *25],
...
Error importing module: No such built-in module: node:sea
    at file:///tmp/fs-fixture-1779072294617-2426-1/sea.mjs:3:32
...
Error importing module: No such built-in module: node:test/reporters
    at file:///tmp/fs-fixture-1779072294617-2426-1/test_reporters.mjs:3:32
...
[Object: null prototype] {
    ...
    arch: "x64",
    argv: <ref *23> [
        "/opt/hostedtoolcache/node/26.1.0/x64/bin/node",
        "/tmp/fs-fixture-1779072294617-2426-1/process.mjs"
    ],
    argv0: "node",
    ...
    default: process {
        ...
        release: <ref *46> {
            name: "node",
            sourceUrl: "https://nodejs.org/download/release/v26.1.0/node-v26.1.0.tar.gz",
            headersUrl: "https://nodejs.org/download/release/v26.1.0/node-v26.1.0-headers.tar.gz"
        },
        ...
        env: <ref *116>  {
            GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_5d798da6-40bc-4cc0-8c1f-9bd217be2a03",
            DOTNET_NOLOGO: "1",
            USER: "runner",
            npm_config_user_agent: "pnpm/10.10.0 npm/? node/v26.1.0 linux x64",
            CI: "true",
            USE_BAZEL_FALLBACK_VERSION: "silent:",
            RUNNER_ENVIRONMENT: "github-hosted",
            GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_5d798da6-40bc-4cc0-8c1f-9bd217be2a03",
            PIPX_HOME: "/opt/pipx",
            npm_node_execpath: "/opt/hostedtoolcache/node/26.1.0/x64/bin/node",
            ...
            GITHUB_HEAD_REF: "",
            SYSTEMD_EXEC_PID: "2100",
            ACTIONS_ORCHESTRATION_ID: "0c20f297-d0af-4631-89d4-8fc5ac664fa0.comparison.__default",
            ...
            GITHUB_RUN_ID: "26010735519",
            GITHUB_REF_TYPE: "branch",
            BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            GITHUB_WORKFLOW_SHA: "064a2f94ae4359f4424ce18ee8580f6a19dade2d",
            GITHUB_BASE_REF: "",
            ImageOS: "ubuntu24",
            ...
            RUNNER_TRACKING_ID: "github_40b2afd2-2d4e-4751-bde2-2088f70805f4",
            INVOCATION_ID: "362cf55feced48659b4f4aa1e7c22ac6",
            RUNNER_TOOL_CACHE: "/opt/hostedtoolcache",
            npm_package_name: "deno-compare-node",
            NODE: "/opt/hostedtoolcache/node/26.1.0/x64/bin/node",
            ...
            RUNNER_NAME: "GitHub Actions 1000003838",
            ...
            GITHUB_SHA: "064a2f94ae4359f4424ce18ee8580f6a19dade2d",
            GITHUB_RUN_ATTEMPT: "1",
            GITHUB_REF: "refs/heads/main",
            GITHUB_ACTOR: "outslept",
            ANDROID_SDK_ROOT: "/usr/local/lib/android/sdk",
            GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_5d798da6-40bc-4cc0-8c1f-9bd217be2a03",
            ...
            GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_5d798da6-40bc-4cc0-8c1f-9bd217be2a03",
            ...
            GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_5d798da6-40bc-4cc0-8c1f-9bd217be2a03",
        ...
        pid: 2864,
        ppid: 2426,
        execPath: "/opt/hostedtoolcache/node/26.1.0/x64/bin/node",
        debugPort: 9229,
        argv0: "node",
...
[Object: null prototype] {
    ...
    arch: "x64",
    argv: <ref *6> [
        "/opt/hostedtoolcache/deno/0.0.0-6dca9216f575aec2732e4682755943ef80475ac6/x64/deno",
        "/tmp/fs-fixture-1779072294617-2426-1/process.mjs"
    ],
    argv0: "deno",
    ...
    default: process {
        ...
        threadCpuUsage: <ref *23> ƒ threadCpuUsage(length: 1) {},
        cwd: [Circular: *11],
        env: <ref *24> {
            npm_config_node_gyp: "/home/runner/setup-pnpm/node_modules/.pnpm/pnpm@10.10.0/node_modules/pnpm/dist/node_modules/node-gyp…",
            INIT_CWD: "/home/runner/work/deno-compare-node/deno-compare-node",
        ...
        execArgv: <ref *25> [],
        exit: <ref *26> ƒ exit(length: 1) {},
        abort: [Circular: *2],
        openStdin: ƒ (length: 0) {},
        _rawDebug: ƒ (length: 0) {},
        getActiveResourcesInfo: <ref *29> ƒ getActiveResourcesInfo(length: 0) {},
        ...
        binding: ƒ (length: 1) {},
        umask: <ref *83> ƒ umask(length: 1) {},
        getgid: <ref *84> ƒ getgid(length: 0) {},
        getuid: <ref *85> ƒ getuid(length: 0) {},
        getgroups: ƒ (length: 0) {},
        getegid: <ref *87> ƒ getegid(length: 0) {},
        geteuid: <ref *88> ƒ geteuid(length: 0) {},
        setegid: <ref *89> ƒ (length: 1) {},
        seteuid: <ref *90> ƒ (length: 1) {},
        setgid: <ref *91> ƒ (length: 1) {},
        setuid: <ref *92> ƒ (length: 1) {},
        getBuiltinModule: <ref *93> ƒ getBuiltinModule(length: 1) {},
        _eval: undefined,
        loadEnvFile: <ref *94> ƒ loadEnvFile(length: 0) {},
        uptime: ƒ (length: 0) {},
        features: {
            inspector: true,
            debug: false,
    ...
    env: [Circular: *24],
    execArgv: [Circular: *25],
    execPath: "/opt/hostedtoolcache/deno/0.0.0-6dca9216f575aec2732e4682755943ef80475ac6/x64/deno",
    exit: [Circular: *26],
    getActiveResourcesInfo: [Circular: *29],
    getBuiltinModule: [Circular: *93],
    getegid: [Circular: *87],
    geteuid: [Circular: *88],
    getgid: [Circular: *84],
    getuid: [Circular: *85],
    hrtime: [Circular: *39],
    kill: [Circular: *42],
    loadEnvFile: [Circular: *94],
    memoryUsage: [Circular: *43],
    nextTick: [Circular: *36],
    pid: 2865,
    platform: "linux",
    ppid: 2426,
    ...
    stdin: [Circular: *55],
    stdout: [Circular: *71],
    threadCpuUsage: [Circular: *23],
    umask: [Circular: *83],
    version: "v24.2.0",
    versions: [Circular: *80]
}
```
...
(node:3026) [DEP0025] DeprecationWarning: sys is deprecated. Use `node:util` instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
...
[Object: null prototype] {
    ...
    default: {
        ...
        MIMEParams: [Circular: *2],
        MIMEType: [Circular: *3],
        parseArgs: <ref *61> ƒ parseArgs(length: 0) {},
        promisify: <ref *62> ƒ promisify(length: 1) {
            custom: Symbol(nodejs.util.promisify.custom)
        },
        stripVTControlCharacters: <ref *63> ƒ stripVTControlCharacters(length: 1) {},
        styleText: <ref *64> ƒ styleText(length: 3) {},
        types: <ref *65> {
        ...
        isArray: <ref *108> ƒ isArray(length: 1) {},
        _extend: [Circular: *6],
        inherits: <ref *109> ƒ inherits(length: 2) {},
        TextDecoder: [Circular: *4],
        TextEncoder: [Circular: *5],
        toUSVString: <ref *110> ƒ toUSVString(length: 1) {},
        log: <ref *111> ƒ log(length: 0) {},
        deprecate: <ref *112> ƒ deprecate(length: 3) {},
        aborted: [Circular: *7],
        getCallSites: <ref *113> ƒ getCallSites(length: 0) {},
        parseEnv: <ref *114> ƒ parseEnv(length: 1) {},
        queryObjects: <ref *115> ƒ queryObjects(length: 2) {},
        setTraceSigInt: <ref *116> ƒ setTraceSigInt(length: 1) {},
        convertProcessSignalToExitCode: [Circular: *9],
        getSystemErrorMessage: <ref *117> ƒ getSystemErrorMessage(length: 1) {},
        getSystemErrorName: <ref *118> ƒ getSystemErrorName(length: 1) {},
        isDeepStrictEqual: <ref *119> ƒ isDeepStrictEqual(length: 3) {}
    },
    deprecate: [Circular: *112],
    format: [Circular: *12],
    formatWithOptions: [Circular: *13],
    getCallSites: [Circular: *113],
    getSystemErrorMessage: [Circular: *117],
    getSystemErrorName: [Circular: *118],
    inherits: [Circular: *109],
    inspect: [Circular: *14],
    isArray: [Circular: *108],
    isDeepStrictEqual: [Circular: *119],
    log: [Circular: *111],
    parseArgs: [Circular: *61],
    parseEnv: [Circular: *114],
    promisify: [Circular: *62],
    queryObjects: [Circular: *115],
    setTraceSigInt: [Circular: *116],
    stripVTControlCharacters: [Circular: *63],
    styleText: [Circular: *64],
    toUSVString: [Circular: *110],
    types: [Circular: *65]
}
```
...
[Object: null prototype] {
    ...
    default: {
        ...
        setFlagsFromString: <ref *14> ƒ setFlagsFromString(length: 0) {},
        startupSnapshot: <ref *15> {
        ...
        stopCoverage: <ref *20> ƒ stopCoverage(length: 0) {},
        takeCoverage: <ref *21> ƒ takeCoverage(length: 0) {},
        writeHeapSnapshot: <ref *22> ƒ writeHeapSnapshot(length: 2) {},
        serialize: <ref *23> ƒ serialize(length: 1) {},
        deserialize: <ref *24> ƒ deserialize(length: 1) {},
        GCProfiler: [Circular: *5],
        Serializer: [Circular: *6],
        Deserializer: [Circular: *4],
        DefaultSerializer: [Circular: *3],
    ...
    deserialize: [Circular: *24],
    getHeapCodeStatistics: [Circular: *9],
    getHeapSnapshot: [Circular: *10],
    getHeapSpaceStatistics: [Circular: *11],
    getHeapStatistics: [Circular: *12],
    queryObjects: [Circular: *13],
    serialize: [Circular: *23],
    setFlagsFromString: [Circular: *14],
    startupSnapshot: [Circular: *15],
    stopCoverage: [Circular: *20],
    takeCoverage: [Circular: *21],
    writeHeapSnapshot: [Circular: *22]
}
```
...
(node:3204) ExperimentalWarning: WASI is an experimental feature and might change at any time
...
[Object: null prototype] {
    ...
    default: {
        ...
        threadName: "",
        markAsUntransferable: <ref *8> ƒ markAsUntransferable(length: 1) {},
        moveMessagePortToContext: <ref *9> ƒ moveMessagePortToContext(length: 0) {},
        postMessageToThread: <ref *10> ƒ postMessageToThread(length: 4) {},
        receiveMessageOnPort: <ref *11> ƒ receiveMessageOnPort(length: 1) {},
        getEnvironmentData: <ref *12> ƒ getEnvironmentData(length: 1) {},
        setEnvironmentData: <ref *13> ƒ setEnvironmentData(length: 2) {},
        SHARE_ENV: Symbol(nodejs.worker_threads.SHARE_ENV)
    },
    getEnvironmentData: [Circular: *12],
    isMainThread: true,
    markAsUntransferable: [Circular: *8],
    moveMessagePortToContext: [Circular: *9],
    parentPort: null,
    postMessageToThread: [Circular: *10],
    receiveMessageOnPort: [Circular: *11],
    resourceLimits: [Circular: *7],
    setEnvironmentData: [Circular: *13],
    threadId: 0,
    threadName: "",
    workerData: null
}
