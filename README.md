...
Updated May 25, 2026 • Node.js v26.2.0 • deno 2.8.0+1fab348 (canary, release, x86_64-unknown-linux-gnu)
...
[Object: null prototype] {
    EventEmitter: <ref *2> ƒ EventEmitter(length: 1) {
        ...
        [get/set] defaultMaxListeners: 10,
        init: ƒ (length: 1) {},
        [get/set] EventEmitterAsyncResource: <ref *11> class EventEmitterAsyncResource
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        _pathCache: <ref *4> [Object: null prototype] {
            /tmp/fs-fixture-1779677473380-2456-1/module.mjs: "/tmp/fs-fixture-1779677473380-2456-1/module.mjs"
        },
        ...
        globalPaths: <ref *9> [
            ...
            "/opt/hostedtoolcache/node/26.2.0/x64/lib/node"
        ],
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        registerHooks: <ref *32> ƒ registerHooks(length: 1) {},
        register: <ref *33> ƒ register(length: 3) {}
    },
...
Error importing module: No such built-in module: node:sea
    at file:///tmp/fs-fixture-1779677473380-2456-1/sea.mjs:3:32
...
Error importing module: No such built-in module: node:test/reporters
    at file:///tmp/fs-fixture-1779677473380-2456-1/test_reporters.mjs:3:32
...
[Object: null prototype] {
    ...
    arch: "x64",
    argv: <ref *23> [
        "/opt/hostedtoolcache/node/26.2.0/x64/bin/node",
        "/tmp/fs-fixture-1779677473380-2456-1/process.mjs"
    ],
    argv0: "node",
    ...
    default: process {
        ...
        release: <ref *46> {
            name: "node",
            sourceUrl: "https://nodejs.org/download/release/v26.2.0/node-v26.2.0.tar.gz",
            headersUrl: "https://nodejs.org/download/release/v26.2.0/node-v26.2.0-headers.tar.gz"
        },
        ...
        env: <ref *116>  {
            GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_a1c399c9-aa68-40be-9ab4-559ba9a39391",
            DOTNET_NOLOGO: "1",
            USER: "runner",
            npm_config_user_agent: "pnpm/10.10.0 npm/? node/v26.2.0 linux x64",
            CI: "true",
            USE_BAZEL_FALLBACK_VERSION: "silent:",
            RUNNER_ENVIRONMENT: "github-hosted",
            GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_a1c399c9-aa68-40be-9ab4-559ba9a39391",
            PIPX_HOME: "/opt/pipx",
            npm_node_execpath: "/opt/hostedtoolcache/node/26.2.0/x64/bin/node",
            ...
            ACTIONS_ORCHESTRATION_ID: "191833a6-2f4d-442e-9d68-d30a07eb9ad6.comparison.__default",
            ...
            GITHUB_RUN_ID: "26380645821",
            GITHUB_REF_TYPE: "branch",
            BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            GITHUB_WORKFLOW_SHA: "5eaf41fcefaf809bc544b4698d30b039d2180cd1",
            GITHUB_BASE_REF: "",
            ImageOS: "ubuntu24",
            ...
            RUNNER_TRACKING_ID: "github_8f6de807-8137-44ca-81d3-1af5e40b4430",
            INVOCATION_ID: "70de60c381d54252ac6751fcb69c1ba8",
            RUNNER_TOOL_CACHE: "/opt/hostedtoolcache",
            npm_package_name: "deno-compare-node",
            NODE: "/opt/hostedtoolcache/node/26.2.0/x64/bin/node",
            ...
            RUNNER_NAME: "GitHub Actions 1000003851",
            ...
            GITHUB_SHA: "5eaf41fcefaf809bc544b4698d30b039d2180cd1",
            GITHUB_RUN_ATTEMPT: "1",
            GITHUB_REF: "refs/heads/main",
            GITHUB_ACTOR: "outslept",
            ANDROID_SDK_ROOT: "/usr/local/lib/android/sdk",
            GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_a1c399c9-aa68-40be-9ab4-559ba9a39391",
            ...
            GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_a1c399c9-aa68-40be-9ab4-559ba9a39391",
            ...
            GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_a1c399c9-aa68-40be-9ab4-559ba9a39391",
        ...
        pid: 2898,
        ppid: 2456,
        execPath: "/opt/hostedtoolcache/node/26.2.0/x64/bin/node",
        debugPort: 9229,
        argv0: "node",
...
[Object: null prototype] {
    ...
    arch: "x64",
    argv: <ref *6> [
        "/opt/hostedtoolcache/deno/0.0.0-1fab34851860fa6bb38d15033cd37939e47153af/x64/deno",
        "/tmp/fs-fixture-1779677473380-2456-1/process.mjs"
    ],
    argv0: "deno",
    ...
    execPath: "/opt/hostedtoolcache/deno/0.0.0-1fab34851860fa6bb38d15033cd37939e47153af/x64/deno",
    exit: [Circular: *26],
...
[Object: null prototype] {
    ...
    default: {
        ...
        threadName: "",
        markAsUncloneable: <ref *8> ƒ markAsUncloneable(length: 1) {},
        markAsUntransferable: <ref *9> ƒ markAsUntransferable(length: 1) {},
        isMarkedAsUntransferable: <ref *10> ƒ isMarkedAsUntransferable(length: 1) {},
        moveMessagePortToContext: <ref *11> ƒ moveMessagePortToContext(length: 2) {},
        postMessageToThread: <ref *12> ƒ postMessageToThread(length: 4) {},
        receiveMessageOnPort: <ref *13> ƒ receiveMessageOnPort(length: 1) {},
        getEnvironmentData: <ref *14> ƒ getEnvironmentData(length: 1) {},
        setEnvironmentData: <ref *15> ƒ setEnvironmentData(length: 2) {},
        SHARE_ENV: Symbol(nodejs.worker_threads.SHARE_ENV)
    },
    getEnvironmentData: [Circular: *14],
    isMainThread: true,
    isMarkedAsUntransferable: [Circular: *10],
    markAsUncloneable: [Circular: *8],
    markAsUntransferable: [Circular: *9],
    moveMessagePortToContext: [Circular: *11],
    parentPort: null,
    postMessageToThread: [Circular: *12],
    receiveMessageOnPort: [Circular: *13],
    resourceLimits: [Circular: *7],
    setEnvironmentData: [Circular: *15],
    threadId: 0,
    threadName: "",
    workerData: null
}
