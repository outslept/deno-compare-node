...
Updated Mar 30, 2026 • Node.js v25.8.2 • deno 2.7.9+af49b5b (canary, release, x86_64-unknown-linux-gnu)
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        _pathCache: <ref *4> [Object: null prototype] {
            /tmp/fs-fixture-1774835837557-2423-1/module.mjs: "/tmp/fs-fixture-1774835837557-2423-1/module.mjs"
        },
        ...
        globalPaths: <ref *9> [
            ...
            "/opt/hostedtoolcache/node/25.8.2/x64/lib/node"
        ],
...
Error importing module: No such built-in module: node:sea
    at file:///tmp/fs-fixture-1774835837557-2423-1/sea.mjs:3:32
...
Error importing module: No such built-in module: node:test/reporters
    at file:///tmp/fs-fixture-1774835837557-2423-1/test_reporters.mjs:3:32
...
[Object: null prototype] {
    ...
    arch: "x64",
    argv: <ref *22> [
        "/opt/hostedtoolcache/node/25.8.2/x64/bin/node",
        "/tmp/fs-fixture-1774835837557-2423-1/process.mjs"
    ],
    argv0: "node",
    ...
    default: process {
        ...
        release: <ref *45> {
            name: "node",
            sourceUrl: "https://nodejs.org/download/release/v25.8.2/node-v25.8.2.tar.gz",
            headersUrl: "https://nodejs.org/download/release/v25.8.2/node-v25.8.2-headers.tar.gz"
        },
        ...
        env: <ref *115>  {
            GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_3571bb87-9578-4b31-9353-42c6ae4c9256",
            DOTNET_NOLOGO: "1",
            USER: "runner",
            npm_config_user_agent: "pnpm/10.10.0 npm/? node/v25.8.2 linux x64",
            CI: "true",
            USE_BAZEL_FALLBACK_VERSION: "silent:",
            RUNNER_ENVIRONMENT: "github-hosted",
            GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_3571bb87-9578-4b31-9353-42c6ae4c9256",
            PIPX_HOME: "/opt/pipx",
            npm_node_execpath: "/opt/hostedtoolcache/node/25.8.2/x64/bin/node",
            ...
            GITHUB_HEAD_REF: "",
            SYSTEMD_EXEC_PID: "2088",
            ACTIONS_ORCHESTRATION_ID: "c9db8c30-5eea-4598-afef-c9a71623ac77.comparison.__default",
            ...
            GITHUB_RUN_ID: "23724638167",
            GITHUB_REF_TYPE: "branch",
            BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            GITHUB_WORKFLOW_SHA: "a4c52327000a0d8c0450d8bb54e5c5e25f980268",
            GITHUB_BASE_REF: "",
            ImageOS: "ubuntu24",
            ...
            RUNNER_TRACKING_ID: "github_ec00c463-2aba-40a9-8c05-71768f3f87b4",
            INVOCATION_ID: "88ae9de818fb46bd87da0437837018b0",
            RUNNER_TOOL_CACHE: "/opt/hostedtoolcache",
            npm_package_name: "deno-compare-node",
            NODE: "/opt/hostedtoolcache/node/25.8.2/x64/bin/node",
            ...
            RUNNER_NAME: "GitHub Actions 1000003735",
            ...
            GITHUB_SHA: "a4c52327000a0d8c0450d8bb54e5c5e25f980268",
            GITHUB_RUN_ATTEMPT: "1",
            GITHUB_REF: "refs/heads/main",
            GITHUB_ACTOR: "outslept",
            ANDROID_SDK_ROOT: "/usr/local/lib/android/sdk",
            GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_3571bb87-9578-4b31-9353-42c6ae4c9256",
            ...
            GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_3571bb87-9578-4b31-9353-42c6ae4c9256",
            ...
            GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_3571bb87-9578-4b31-9353-42c6ae4c9256",
        ...
        pid: 2864,
        ppid: 2423,
        execPath: "/opt/hostedtoolcache/node/25.8.2/x64/bin/node",
        debugPort: 9229,
        argv0: "node",
...
[Object: null prototype] {
    ...
    arch: "x64",
    argv: <ref *6> [
        "/opt/hostedtoolcache/deno/0.0.0-af49b5bbb32a45e6b62e6f2e01492aa552fa271a/x64/deno",
        "/tmp/fs-fixture-1774835837557-2423-1/process.mjs"
    ],
    argv0: "deno",
    ...
    default: process {
        ...
        nextTick: <ref *27> ƒ nextTick(length: 1) {},
        dlopen: <ref *28> ƒ dlopen(length: 3) {},
        setSourceMapsEnabled: ƒ (length: 1) {},
        [get/set] sourceMapsEnabled: true,
        hrtime: <ref *30> ƒ hrtime(length: 1) {
            bigint: ƒ (length: 0) {}
        },
        _kill: ƒ _kill(length: 2) {},
        kill: <ref *33> ƒ kill(length: 1) {},
        memoryUsage: <ref *34> ƒ memoryUsage(length: 0) {
            rss: ƒ (length: 0) {}
        },
        availableMemory: [Circular: *7],
        constrainedMemory: [Circular: *9],
        stderr: <ref *36> Writable {
            _events: {
                close: undefined,
                error: undefined,
                prefinish: undefined,
        ...
        emitWarning: <ref *72> ƒ emitWarning(length: 4) {},
        binding: ƒ (length: 1) {},
        umask: <ref *74> ƒ umask(length: 1) {},
        getgid: <ref *75> ƒ getgid(length: 0) {},
        getuid: <ref *76> ƒ getuid(length: 0) {},
        getgroups: ƒ (length: 0) {},
        getegid: <ref *78> ƒ getegid(length: 0) {},
        geteuid: <ref *79> ƒ geteuid(length: 0) {},
        setegid: <ref *80> ƒ (length: 1) {},
        seteuid: <ref *81> ƒ (length: 1) {},
        setgid: <ref *82> ƒ (length: 1) {},
        setuid: <ref *83> ƒ (length: 1) {},
        getBuiltinModule: <ref *84> ƒ getBuiltinModule(length: 1) {},
        _eval: undefined,
        loadEnvFile: <ref *85> ƒ loadEnvFile(length: 0) {},
        uptime: ƒ (length: 0) {},
        features: {
            inspector: true,
            debug: false,
    ...
    execPath: "/opt/hostedtoolcache/deno/0.0.0-af49b5bbb32a45e6b62e6f2e01492aa552fa271a/x64/deno",
    exit: [Circular: *20],
    ...
    stdin: [Circular: *46],
    stdout: [Circular: *62],
    threadCpuUsage: [Circular: *17],
    umask: [Circular: *74],
    version: "v24.2.0",
    versions: [Circular: *71]
}
```
...
(node:2871) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
...
(node:3034) [DEP0025] DeprecationWarning: sys is deprecated. Use `node:util` instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
...
[Object: null prototype] {
    ...
    default: {
        ...
        formatWithOptions: <ref *13> ƒ formatWithOptions(length: 1) {},
        inspect: <ref *14> ƒ inspect(length: 2) {
            colors: {
                reset: [
                    0,
                    0
        ...
        getCallSites: <ref *61> ƒ getCallSites(length: 0) {},
        getSystemErrorName: <ref *62> ƒ getSystemErrorName(length: 1) {},
        getSystemErrorMessage: <ref *63> ƒ getSystemErrorMessage(length: 1) {},
        aborted: [Circular: *7],
        deprecate: <ref *64> ƒ deprecate(length: 3) {},
        callbackify: [Circular: *8],
        parseArgs: <ref *65> ƒ parseArgs(length: 0) {},
        MIMEParams: [Circular: *2],
        MIMEType: [Circular: *3],
        promisify: <ref *66> ƒ promisify(length: 1) {
            custom: Symbol(nodejs.util.promisify.custom)
        },
        inherits: <ref *67> ƒ inherits(length: 2) {},
        types: <ref *68> {
        ...
        stripVTControlCharacters: <ref *111> ƒ stripVTControlCharacters(length: 1) {},
        TextDecoder: [Circular: *4],
        TextEncoder: [Circular: *5],
        toUSVString: <ref *112> ƒ toUSVString(length: 1) {},
        log: <ref *113> ƒ log(length: 0) {},
        debuglog: [Circular: *10],
        debug: [Circular: *10],
    ...
    format: [Circular: *12],
    formatWithOptions: [Circular: *13],
    getCallSites: [Circular: *61],
    getSystemErrorMessage: [Circular: *63],
    getSystemErrorName: [Circular: *62],
    inherits: [Circular: *67],
    inspect: [Circular: *14],
    isArray: [Circular: *115],
    isDeepStrictEqual: [Circular: *114],
    log: [Circular: *113],
    parseArgs: [Circular: *65],
    parseEnv: [Circular: *117],
    promisify: [Circular: *66],
    stripVTControlCharacters: [Circular: *111],
    styleText: [Circular: *116],
    toUSVString: [Circular: *112],
    types: [Circular: *68]
}
```
...
Error importing module: No such built-in module: node:trace_events
    at file:///tmp/fs-fixture-1774835837557-2423-1/trace_events.mjs:3:32
...
(node:3195) ExperimentalWarning: WASI is an experimental feature and might change at any time
