...
Updated Mar 23, 2026 • Node.js v25.8.1 • deno 2.7.7+ac659a1 (canary, release, x86_64-unknown-linux-gnu)
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        _pathCache: <ref *4> [Object: null prototype] {
            /tmp/fs-fixture-1774230487693-2450-1/module.mjs: "/tmp/fs-fixture-1774230487693-2450-1/module.mjs"
        },
...
Error importing module: No such built-in module: node:sea
    at file:///tmp/fs-fixture-1774230487693-2450-1/sea.mjs:3:32
...
Error importing module: No such built-in module: node:test/reporters
    at file:///tmp/fs-fixture-1774230487693-2450-1/test_reporters.mjs:3:32
...
[Object: null prototype] {
    ...
    argv: <ref *22> [
        ...
        "/tmp/fs-fixture-1774230487693-2450-1/process.mjs"
    ],
    argv0: "node",
    ...
    default: process {
        ...
        env: <ref *115>  {
            GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_9e23cfa1-b402-4a99-ad95-72c6bf37d620",
            DOTNET_NOLOGO: "1",
            USER: "runner",
            ...
            GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_9e23cfa1-b402-4a99-ad95-72c6bf37d620",
            PIPX_HOME: "/opt/pipx",
            ...
            ACTIONS_ORCHESTRATION_ID: "fb219147-8e8c-49f3-af4e-ced0d123adff.comparison.__default",
            ...
            GITHUB_RUN_ID: "23417964862",
            GITHUB_REF_TYPE: "branch",
            BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            GITHUB_WORKFLOW_SHA: "3e070efed0baec4e204b4808034bd9198abdf16a",
            GITHUB_BASE_REF: "",
            ImageOS: "ubuntu24",
            ...
            RUNNER_TRACKING_ID: "github_691bd931-3cb8-43c0-9a0d-f039c79574c1",
            INVOCATION_ID: "3d4836e2aaab408fbda421ded3cd2ae6",
            ...
            RUNNER_NAME: "GitHub Actions 1000003722",
            ...
            GITHUB_SHA: "3e070efed0baec4e204b4808034bd9198abdf16a",
            GITHUB_RUN_ATTEMPT: "1",
            GITHUB_REF: "refs/heads/main",
            GITHUB_ACTOR: "outslept",
            ANDROID_SDK_ROOT: "/usr/local/lib/android/sdk",
            GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_9e23cfa1-b402-4a99-ad95-72c6bf37d620",
            ...
            GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_9e23cfa1-b402-4a99-ad95-72c6bf37d620",
            ...
            GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_9e23cfa1-b402-4a99-ad95-72c6bf37d620",
...
[Object: null prototype] {
    ...
    default: process {
        ...
        nextTick: <ref *25> ƒ nextTick(length: 1) {},
        dlopen: <ref *26> ƒ dlopen(length: 3) {},
        setSourceMapsEnabled: ƒ (length: 1) {},
        [get/set] sourceMapsEnabled: true,
        hrtime: <ref *28> ƒ hrtime(length: 1) {
            bigint: ƒ (length: 0) {}
        },
        _kill: ƒ _kill(length: 2) {},
        kill: <ref *31> ƒ kill(length: 1) {},
        memoryUsage: <ref *32> ƒ memoryUsage(length: 0) {
            rss: ƒ (length: 0) {}
        },
        availableMemory: [Circular: *7],
        constrainedMemory: [Circular: *9],
        stderr: <ref *34> Writable {
            _events: {
                close: undefined,
                error: undefined,
                prefinish: undefined,
        ...
        emitWarning: <ref *70> ƒ emitWarning(length: 4) {},
        binding: ƒ (length: 1) {},
        umask: <ref *72> ƒ umask(length: 1) {},
        getgid: <ref *73> ƒ getgid(length: 0) {},
        getuid: <ref *74> ƒ getuid(length: 0) {},
        getgroups: ƒ (length: 0) {},
        getegid: <ref *76> ƒ getegid(length: 0) {},
        geteuid: <ref *77> ƒ geteuid(length: 0) {},
        setegid: <ref *78> ƒ (length: 1) {},
        seteuid: <ref *79> ƒ (length: 1) {},
        setgid: <ref *80> ƒ (length: 1) {},
        setuid: <ref *81> ƒ (length: 1) {},
        getBuiltinModule: <ref *82> ƒ getBuiltinModule(length: 1) {},
        _eval: undefined,
        loadEnvFile: <ref *83> ƒ loadEnvFile(length: 0) {},
        uptime: ƒ (length: 0) {},
        features: {
            inspector: true,
            debug: false,
    ...
    dlopen: [Circular: *26],
    emitWarning: [Circular: *70],
    env: [Circular: *18],
    execArgv: [Circular: *19],
    execPath: "/opt/hostedtoolcache/deno/0.0.0-ac659a17c799c0e03530acd73524596f62f108fd/x64/deno",
    exit: [Circular: *20],
    ...
    hrtime: [Circular: *28],
    kill: [Circular: *31],
    loadEnvFile: [Circular: *83],
    memoryUsage: [Circular: *32],
    nextTick: [Circular: *25],
    pid: 2899,
    platform: "linux",
    ppid: 2450,
...
(node:2913) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
...
(node:3059) [DEP0025] DeprecationWarning: sys is deprecated. Use `node:util` instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
...
Error importing module: No such built-in module: node:trace_events
    at file:///tmp/fs-fixture-1774230487693-2450-1/trace_events.mjs:3:32
...
(node:3227) ExperimentalWarning: WASI is an experimental feature and might change at any time
