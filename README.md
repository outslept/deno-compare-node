...
Updated Apr 13, 2026 • Node.js v25.9.0 • deno 2.7.12+e99152e (canary, release, x86_64-unknown-linux-gnu)
...
[Object: null prototype] {
    ...
    WriteStream: <ref *9> ƒ WriteStream(length: 2) {},
    _toUnixTimestamp: <ref *10> ƒ toUnixTimestamp(length: 1) {},
    access: <ref *11> ƒ access(length: 3) {},
    accessSync: <ref *12> ƒ accessSync(length: 2) {},
    appendFile: <ref *13> ƒ appendFile(length: 4) {},
    appendFileSync: <ref *14> ƒ appendFileSync(length: 3) {},
    chmod: <ref *15> ƒ chmod(length: 3) {},
    chmodSync: <ref *16> ƒ chmodSync(length: 2) {},
    chown: <ref *17> ƒ chown(length: 4) {},
    chownSync: <ref *18> ƒ chownSync(length: 3) {},
    close: <ref *19> ƒ close(length: 1) {},
    closeSync: <ref *20> ƒ closeSync(length: 1) {},
    ...
    copyFile: <ref *24> ƒ copyFile(length: 4) {},
    copyFileSync: <ref *25> ƒ copyFileSync(length: 3) {},
    cp: <ref *26> ƒ cp(length: 4) {},
    cpSync: <ref *27> ƒ cpSync(length: 3) {},
    createReadStream: <ref *28> ƒ createReadStream(length: 2) {},
    createWriteStream: <ref *29> ƒ createWriteStream(length: 2) {},
    default: {
        access: [Circular: *11],
        accessSync: [Circular: *12],
        appendFile: [Circular: *13],
        appendFileSync: [Circular: *14],
        chmod: [Circular: *15],
        chmodSync: [Circular: *16],
        chown: [Circular: *17],
        chownSync: [Circular: *18],
        close: [Circular: *19],
        closeSync: [Circular: *20],
        constants: [Circular: *21],
        copyFile: [Circular: *24],
        copyFileSync: [Circular: *25],
        cp: [Circular: *26],
        cpSync: [Circular: *27],
        createReadStream: [Circular: *28],
        createWriteStream: [Circular: *29],
        Dir: [Circular: *4],
        Dirent: [Circular: *5],
        exists: <ref *31> ƒ exists(length: 2) {},
        existsSync: <ref *32> ƒ existsSync(length: 1) {},
        fchmod: <ref *33> ƒ fchmod(length: 3) {},
        fchmodSync: <ref *34> ƒ fchmodSync(length: 2) {},
        fchown: <ref *35> ƒ fchown(length: 4) {},
        fchownSync: <ref *36> ƒ fchownSync(length: 3) {},
        fdatasync: <ref *37> ƒ fdatasync(length: 2) {},
        fdatasyncSync: <ref *38> ƒ fdatasyncSync(length: 1) {},
        fstat: <ref *39> ƒ fstat(length: 3) {},
        fstatSync: <ref *40> ƒ fstatSync(length: 2) {},
        fsync: <ref *41> ƒ fsync(length: 2) {},
        fsyncSync: <ref *42> ƒ fsyncSync(length: 1) {},
        ftruncate: <ref *43> ƒ ftruncate(length: 3) {},
        ftruncateSync: <ref *44> ƒ ftruncateSync(length: 2) {},
        futimes: <ref *45> ƒ futimes(length: 4) {},
        futimesSync: <ref *46> ƒ futimesSync(length: 3) {},
        glob: <ref *47> ƒ glob(length: 2) {},
        globSync: <ref *48> ƒ globSync(length: 1) {},
        lchmod: undefined,
        lchmodSync: undefined,
        lchown: <ref *49> ƒ lchown(length: 4) {},
        lchownSync: <ref *50> ƒ lchownSync(length: 3) {},
        link: <ref *51> ƒ link(length: 3) {},
        linkSync: <ref *52> ƒ linkSync(length: 2) {},
        lstat: <ref *53> ƒ lstat(length: 3) {},
        lstatSync: <ref *54> ƒ lstatSync(length: 2) {},
        lutimes: <ref *55> ƒ lutimes(length: 4) {},
        lutimesSync: <ref *56> ƒ lutimesSync(length: 3) {},
        mkdir: <ref *57> ƒ mkdir(length: 3) {},
        mkdirSync: <ref *58> ƒ mkdirSync(length: 2) {},
        mkdtemp: <ref *59> ƒ mkdtemp(length: 3) {},
        mkdtempSync: <ref *60> ƒ mkdtempSync(length: 2) {},
        open: <ref *61> ƒ open(length: 4) {},
        openAsBlob: <ref *62> ƒ openAsBlob(length: 1) {},
        openSync: <ref *63> ƒ openSync(length: 1) {},
        opendir: <ref *64> ƒ opendir(length: 3) {},
        opendirSync: <ref *65> ƒ opendirSync(length: 2) {},
        read: <ref *66> ƒ read(length: 6) {},
        readSync: <ref *67> ƒ readSync(length: 5) {},
        promises: <ref *68> {
            ...
            watch: <ref *99> ƒ watchPromise(length: 2) {}
        },
        readdir: <ref *100> ƒ readdir(length: 3) {},
        readdirSync: <ref *101> ƒ readdirSync(length: 2) {},
        readFile: <ref *102> ƒ readFile(length: 3) {},
        readFilePromise: <ref *103> ƒ readFilePromise(length: 2) {},
        readFileSync: <ref *104> ƒ readFileSync(length: 2) {},
        readlink: <ref *105> ƒ readlink(length: 3) {},
        readlinkPromise: <ref *106> ƒ readlink(length: 3) {},
        readlinkSync: <ref *107> ƒ readlinkSync(length: 2) {},
        ReadStream: [Circular: *6],
        realpath: <ref *108> ƒ realpath(length: 3) {
            native: [Circular: *108]
        },
        realpathSync: <ref *109> ƒ realpathSync(length: 2) {
            native: [Circular: *109]
        },
        readv: <ref *110> ƒ readv(length: 4) {},
        readvSync: <ref *111> ƒ readvSync(length: 2) {},
        rename: <ref *112> ƒ rename(length: 3) {},
        renameSync: <ref *113> ƒ renameSync(length: 2) {},
        rmdir: <ref *114> ƒ rmdir(length: 3) {},
        rmdirSync: <ref *115> ƒ rmdirSync(length: 2) {},
        rm: <ref *116> ƒ rm(length: 3) {},
        rmSync: <ref *117> ƒ rmSync(length: 2) {},
        stat: <ref *118> ƒ stat(length: 1) {},
        Stats: [Circular: *7],
        statSync: <ref *119> ƒ statSync(length: 1) {},
        statfs: <ref *120> ƒ statfs(length: 3) {},
        statfsSync: <ref *121> ƒ statfsSync(length: 2) {},
        symlink: <ref *122> ƒ symlink(length: 4) {},
        symlinkSync: <ref *123> ƒ symlinkSync(length: 3) {},
        truncate: <ref *124> ƒ truncate(length: 3) {},
        truncateSync: <ref *125> ƒ truncateSync(length: 2) {},
        unlink: <ref *126> ƒ unlink(length: 2) {},
        unlinkSync: <ref *127> ƒ unlinkSync(length: 1) {},
        unwatchFile: <ref *128> ƒ unwatchFile(length: 2) {},
        utimes: <ref *129> ƒ utimes(length: 4) {},
        utimesSync: <ref *130> ƒ utimesSync(length: 3) {},
        watch: <ref *131> ƒ watch(length: 3) {},
        watchFile: <ref *132> ƒ watchFile(length: 3) {},
        write: <ref *133> ƒ write(length: 6) {},
        writeFile: <ref *134> ƒ writeFile(length: 4) {},
        writev: <ref *135> ƒ writev(length: 4) {},
        writevSync: <ref *136> ƒ writevSync(length: 3) {},
        writeFileSync: <ref *137> ƒ writeFileSync(length: 3) {},
        WriteStream: [Circular: *9],
        writeSync: <ref *138> ƒ writeSync(length: 5) {},
        SyncWriteStream: [Circular: *8],
        _toUnixTimestamp: [Circular: *10]
    },
    exists: [Circular: *31],
    existsSync: [Circular: *32],
    fchmod: [Circular: *33],
    fchmodSync: [Circular: *34],
    fchown: [Circular: *35],
    fchownSync: [Circular: *36],
    fdatasync: [Circular: *37],
    fdatasyncSync: [Circular: *38],
    fstat: [Circular: *39],
    fstatSync: [Circular: *40],
    fsync: [Circular: *41],
    fsyncSync: [Circular: *42],
    ftruncate: [Circular: *43],
    ftruncateSync: [Circular: *44],
    futimes: [Circular: *45],
    futimesSync: [Circular: *46],
    glob: [Circular: *47],
    globSync: [Circular: *48],
    lchmod: undefined,
    lchmodSync: undefined,
    lchown: [Circular: *49],
    lchownSync: [Circular: *50],
    link: [Circular: *51],
    linkSync: [Circular: *52],
    lstat: [Circular: *53],
    lstatSync: [Circular: *54],
    lutimes: [Circular: *55],
    lutimesSync: [Circular: *56],
    mkdir: [Circular: *57],
    mkdirSync: [Circular: *58],
    mkdtemp: [Circular: *59],
    mkdtempSync: [Circular: *60],
    open: [Circular: *61],
    openAsBlob: [Circular: *62],
    openSync: [Circular: *63],
    opendir: [Circular: *64],
    opendirSync: [Circular: *65],
    promises: [Circular: *68],
    read: [Circular: *66],
    readFile: [Circular: *102],
    readFilePromise: [Circular: *103],
    readFileSync: [Circular: *104],
    readSync: [Circular: *67],
    readdir: [Circular: *100],
    readdirSync: [Circular: *101],
    readlink: [Circular: *105],
    readlinkPromise: [Circular: *106],
    readlinkSync: [Circular: *107],
    readv: [Circular: *110],
    readvPromise: ƒ readvPromise(length: 3) {},
    readvSync: [Circular: *111],
    realpath: [Circular: *108],
    realpathSync: [Circular: *109],
    rename: [Circular: *112],
    renameSync: [Circular: *113],
    rm: [Circular: *116],
    rmSync: [Circular: *117],
    rmdir: [Circular: *114],
    rmdirSync: [Circular: *115],
    stat: [Circular: *118],
    statSync: [Circular: *119],
    statfs: [Circular: *120],
    statfsSync: [Circular: *121],
    symlink: [Circular: *122],
    symlinkSync: [Circular: *123],
    truncate: [Circular: *124],
    truncateSync: [Circular: *125],
    unlink: [Circular: *126],
    unlinkSync: [Circular: *127],
    unwatchFile: [Circular: *128],
    utimes: [Circular: *129],
    utimesSync: [Circular: *130],
    watch: [Circular: *131],
    watchFile: [Circular: *132],
    watchPromise: [Circular: *99],
    write: [Circular: *133],
    writeFile: [Circular: *134],
    writeFileSync: [Circular: *137],
    writeSync: [Circular: *138],
    writev: [Circular: *135],
    writevSync: [Circular: *136]
}
```
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        _pathCache: <ref *4> [Object: null prototype] {
            /tmp/fs-fixture-1776045938036-2361-1/module.mjs: "/tmp/fs-fixture-1776045938036-2361-1/module.mjs"
        },
        ...
        globalPaths: <ref *9> [
            ...
            "/opt/hostedtoolcache/node/25.9.0/x64/lib/node"
        ],
...
Error importing module: No such built-in module: node:sea
    at file:///tmp/fs-fixture-1776045938036-2361-1/sea.mjs:3:32
...
Error importing module: No such built-in module: node:test/reporters
    at file:///tmp/fs-fixture-1776045938036-2361-1/test_reporters.mjs:3:32
...
[Object: null prototype] {
    ...
    argv: <ref *23> [
        ...
        "/tmp/fs-fixture-1776045938036-2361-1/process.mjs"
    ],
    argv0: "node",
    ...
    default: process {
        ...
        release: <ref *46> {
            name: "node",
            sourceUrl: "https://nodejs.org/download/release/v25.9.0/node-v25.9.0.tar.gz",
            headersUrl: "https://nodejs.org/download/release/v25.9.0/node-v25.9.0-headers.tar.gz"
        },
        ...
        env: <ref *116>  {
            GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_5eb81e3a-dab9-4458-9908-63374afbcbe8",
            DOTNET_NOLOGO: "1",
            USER: "runner",
            ...
            GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_5eb81e3a-dab9-4458-9908-63374afbcbe8",
            PIPX_HOME: "/opt/pipx",
            ...
            GITHUB_HEAD_REF: "",
            SYSTEMD_EXEC_PID: "2031",
            ACTIONS_ORCHESTRATION_ID: "6a0226b3-cb8e-4c2f-9cde-758bd1fd50ac.comparison.__default",
            ...
            GITHUB_RUN_ID: "24322329874",
            GITHUB_REF_TYPE: "branch",
            BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            GITHUB_WORKFLOW_SHA: "c2557d97f5c902c5117584f3aad6f4d50f4fb75d",
            GITHUB_BASE_REF: "",
            ImageOS: "ubuntu24",
            ...
            RUNNER_TRACKING_ID: "github_6c2eabeb-987b-4045-bf87-e015134230e0",
            INVOCATION_ID: "06c318b339f24f6d9544141c712a63e0",
            ...
            RUNNER_NAME: "GitHub Actions 1000003767",
            ...
            GITHUB_SHA: "c2557d97f5c902c5117584f3aad6f4d50f4fb75d",
            GITHUB_RUN_ATTEMPT: "1",
            GITHUB_REF: "refs/heads/main",
            GITHUB_ACTOR: "outslept",
            ANDROID_SDK_ROOT: "/usr/local/lib/android/sdk",
            GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_5eb81e3a-dab9-4458-9908-63374afbcbe8",
            ...
            GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_5eb81e3a-dab9-4458-9908-63374afbcbe8",
            ...
            GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_5eb81e3a-dab9-4458-9908-63374afbcbe8",
...
[Object: null prototype] {
    ...
    arch: "x64",
    argv: <ref *6> [
        "/opt/hostedtoolcache/deno/0.0.0-e99152ee24d2d7c16ae0416c1c165e498f07e7a5/x64/deno",
        "/tmp/fs-fixture-1776045938036-2361-1/process.mjs"
    ],
    argv0: "deno",
    ...
    execPath: "/opt/hostedtoolcache/deno/0.0.0-e99152ee24d2d7c16ae0416c1c165e498f07e7a5/x64/deno",
    exit: [Circular: *20],
...
(node:2969) [DEP0025] DeprecationWarning: sys is deprecated. Use `node:util` instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
...
[Object: null prototype] {
    ...
    createSecureContext: <ref *8> ƒ createSecureContext(length: 0) {},
...
Error importing module: No such built-in module: node:trace_events
    at file:///tmp/fs-fixture-1776045938036-2361-1/trace_events.mjs:3:32
...
(node:3143) ExperimentalWarning: WASI is an experimental feature and might change at any time
